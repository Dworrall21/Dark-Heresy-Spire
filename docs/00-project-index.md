...
The project is currently in a **v0.1 playtest chassis** state. The core loop, character creation, advancement, classes, Patron pressure, Heat/Subtlety, GM support, requisition/gear, psychic and forbidden methods, a first playtest mission, and table sheets are present enough to support a first playtest. See [System Progress Tracker v0.1](12-system-progress-tracker-v0.1.md) for current status, design commitments, and next steps.
...
|---:|---|---|---|
| 01 | [Core Rules v0.2](01-core-rules-skeleton-v0.2.md) | Core roll, difficulty, stress, fallout, resistances, clues, threats, and combat | Current |
...
| 06 | [Heat and Subtlety v0.1](06-heat-subtlety-v0.1-outline.md) | Heat, Shadow, Cover, Enemy Awareness, witnesses, evidence, Rosette use | Current |
...
The current playtest chassis, design commitments, immediate next steps, and design status table now live in [System Progress Tracker v0.1](12-system-progress-tracker-v0.1.md).
...
1. Read [Core Rules v0.2](01-core-rules-skeleton-v0.2.md).
